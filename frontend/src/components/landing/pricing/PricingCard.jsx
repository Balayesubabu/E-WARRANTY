  ...
  return (
    <div
      className={cn(
        ...
        popular
          ? "border-2 border-[#0284c7] bg-linear-to-b from-blue-50 to-white shadow-xl scale-[1.02]"
          : "border-2 border-slate-200 bg-white hover:border-slate-300 shadow-md"
      )}
    >
      {/* Popular Badge */}
      {popular && (
      ...
      <div className="space-y-2.5 mt-4 mb-4">
        ...
        {bonus_coins > 0 && (
          <div className="flex items-center justify-between p-2 bg-emerald-50 rounded-lg">
            ...
            <span className="font-semibold text-emerald-700">+{bonus_coins.toLocaleString()}</span>
          </div>
        )}
        ...
        <div className="flex items-center justify-between p-2 bg-amber-50 rounded-lg">
          ...
          <span className="font-bold text-amber-700">{total_coins.toLocaleString()} credits</span>
        </div>
      </div>
