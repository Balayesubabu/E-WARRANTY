...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="py-8 lg:py-10 bg-white scroll-mt-16 lg:scroll-mt-20">
      <Container>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl bg-[#0284c7] p-6 lg:p-8 text-white">
              ...
              <div className="flex flex-col gap-3">
                <button
                  type="button"
                  className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-white text-[#0284c7] font-semibold rounded-xl border-2 border-sky-200 hover:bg-sky-50 transition-colors"
                >
                ...
                {quickLinks.map((link) => {
                  ...
                  return (
                    <li key={link.label}>
                      <a
                        href={link.href}
                        className="flex items-center gap-3 text-slate-600 hover:text-[#0284c7] transition-colors"
                      >
            ...
            {/* Trusted badge */}
            <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-6 flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#0284c7]/10 flex items-center justify-center shrink-0">
                <Check className="w-6 h-6 text-[#0284c7]" strokeWidth={2.5} />
              </div>
              <div>
                <p className="font-bold text-slate-900">TRUSTED FOR 15+ YEARS</p>
                <p className="text-sm text-slate-500">Official Warranty Partner</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-10 border-t border-slate-200 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900 mb-5 max-w-2xl mx-auto leading-tight">
