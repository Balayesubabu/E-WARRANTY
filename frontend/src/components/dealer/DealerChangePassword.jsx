...
import { dealerChangePassword } from '../../services/dealerService';
...
export function DealerChangePassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true);
      await dealerChangePassword(oldPassword, newPassword);
    ...
    <div className="p-4 lg:p-6">
      <div className="max-w-md mx-auto">
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm mt-1">Update your dealer account password</p>
        </div>
        ...
        <div className="mt-4 p-4 bg-amber-50 rounded-xl border border-amber-100">
          <p className="text-amber-700 text-sm">
            After changing your password, you can continue using the app. Your new password will be needed for your next login.
          </p>
        </div>
      </div>
    </div>
