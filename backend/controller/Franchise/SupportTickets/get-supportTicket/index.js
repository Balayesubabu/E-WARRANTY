...
import { getSupportTicketFranchise, getProviderByUserId} from "./query.js";
...
const getSupportTicket = async (req, res) => {
    try {
        ...
        const {supportTicket_id} = req.params;
        ...
        return returnResponse(res, StatusCodes.OK, `get supportTicket successfully`, supportTicket);
    } catch (error) {
        return returnError(res, StatusCodes.INTERNAL_SERVER_ERROR, error);
    }
}

export { getSupportTicket };