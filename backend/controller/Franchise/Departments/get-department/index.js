...
import { getDepartmentFranchise, getProviderByUserId } from "./query.js";
...
const getAllDepartment = async (req, res) => {
    try {
        ...
        const department = await getDepartmentFranchise(franchise_id,provider.id);
        if (!department) {
        ...
        return returnResponse(res, StatusCodes.OK, `fetched department successfully`, department);
    } catch (error) {
