...
import { getProviderByUserId, getAllTemplatesForProvider } from '../query.js';
...
export const getAllTemplatesEndpoint = withProvider(async (req, res, providerId) => {
  const templates = await getAllTemplatesForProvider(providerId);
