...
const searchPurchaseReturnQuery = async (search_query, provider_id, staff_id, franchise_id) => {
    const purchase_returns = await PurchaseInvoice.findMany({
        where: {
...
export { getProviderByUserId, searchPurchaseReturnQuery };