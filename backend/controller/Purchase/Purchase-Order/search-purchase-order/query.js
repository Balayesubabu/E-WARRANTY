...
const searchPurchaseOrderQuery = async (search_query, provider_id, staff_id, franchise_id) => {
    const purchase_orders = await PurchaseInvoice.findMany({
        where: {
...
export { getProviderByUserId, searchPurchaseOrderQuery };