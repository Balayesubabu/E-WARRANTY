...
const getSalesInvoiceByProviderCustomerEndpoint = async (req, res) => {
  try {
    logger.info(`getSalesInvoiceByProviderCustomerEndpoint`);
...
export { getSalesInvoiceByProviderCustomerEndpoint };
