...
const updateProformaInvoiceStatus = async (sales_invoice_id, tx) => {
    const proformaInvoice = await tx.salesInvoice.update({
        where: {
            id: sales_invoice_id
        },
        data: {
            invoice_status: "Proforma_Invoice_Converted",
