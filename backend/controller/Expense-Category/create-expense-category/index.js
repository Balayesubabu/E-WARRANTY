...
const createExpenseCategoryEndpoint = async (req , res) => {
    try {
        ...
        const expense_category = await ExpenseCategory.create({
            data : {
                category : category,
        ...
        return returnResponse(res, StatusCodes.CREATED, `Expense category created successfully`, expense_category);
    } catch (error) {
        return returnError(res, StatusCodes.INTERNAL_SERVER_ERROR, error.message);
    }
}

export {createExpenseCategoryEndpoint}