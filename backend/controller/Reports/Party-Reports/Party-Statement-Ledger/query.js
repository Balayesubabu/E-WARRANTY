import { Provider,Transaction, SalesInvoice, PurchaseInvoice,
    SalesInvoiceTransactions, PurchaseInvoiceTransactions, ProviderCustomers
...
const getCustomerById = async (provider_customer_id, provider_id) => {
    console.log(provider_customer_id, provider_id);
...
const getLedgerStatementByDate = async (provider_customer_id, provider_id, franchise_id) => {
...
export { getProviderByUserId, getCustomerById, getLedgerStatementByDate };
