...
const updateCustomerVehicle = async (customer_vehicle_id, data) => {
    const updatedCustomerVehicle = await ProviderCustomerVehicle.update({
        where: {
...
export { getProviderByUserId, updateCustomerVehicle };