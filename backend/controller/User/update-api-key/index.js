...
const updateApiKeyEndpoint = async (req, res) => {
    try {
        ...
        const { api_key, is_api_key_active, is_api_key_generated, password } = data;
        ...
        return returnResponse(res, StatusCodes.OK, `API key updated successfully`, { api_key: updatedUser.api_key });
    } catch (error) {
